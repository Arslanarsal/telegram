...
| Cold DMs | Existing chats sent first; never-talked-to people capped at 12/day |
| Volume | Hard daily cap of 100 |
...
- **Do not raise `daily_cap`.** 100/day with these delays is roughly 4 hours of
  sending. Pushing to 1000 is where accounts die.
